    ...
    <div className={cl.about} id="#about">
      <div className={cl.bio}>
        <div className={cl.description}>
          As a committed and driven full stack junior web developer, I thrive on
          bringing creative ideas to life through elegant and efficient code.
          With a solid foundation in both front-end and back-end technologies,
          I&apos;m eager to contribute my skills to innovative projects and
          collaborate with like-minded professionals to craft engaging digital
          experiences.
        </div>
      ...
      <div className={cl.skills}>
        <div className={cl.header}>Skills</div>
